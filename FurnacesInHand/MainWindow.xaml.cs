            ...
            using (this.context = new FurnacesModelLocal()) //создали контекст взаимодействия с базой данных
            {
                ...
                switch (this.numberOfFurnace)
                {
                    case 1:
                        ...
                        var graph_pairs = from par in read_parameters_vdp01 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        ...
                        graph_pairs = from par in read_parameters_vdp01 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                    ...
                    case 2:
                        ...
                        graph_pairs = from par in read_parameters_vdp02 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                        ...
                        graph_pairs = from par in read_parameters_vdp02 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        vacuumPlot(graph_pairs);
                        pressureValues.ItemsSource = this.context.vdp02.Where(x => x.tagname == parameter && x.dateandtime >= startTime && x.dateandtime <= finishTime).OrderBy(x => x.id).ToArray();
                        parameter = "Sol_U";
                        read_parameters_vdp02 = this.context.vdp02.Where(x => x.tagname == parameter && x.dateandtime >= startTime && x.dateandtime <= finishTime).OrderBy(x => x.id).ToArray();
                    ...
                    case 3:
                        ...
                        graph_pairs = from par in read_parameters_vdp03 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 4:
                        ...
                        graph_pairs = from par in read_parameters_vdp04 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 5:
                        ...
                        graph_pairs = from par in read_parameters_vdp05 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 6:
                        ...
                        graph_pairs = from par in read_parameters_vdp06 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 7:
                        ...
                        graph_pairs = from par in read_parameters_vdp07 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 8:
                        ...
                        graph_pairs = from par in read_parameters_vdp08 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 9:
                        ...
                        graph_pairs = from par in read_parameters_vdp09 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 10:
                        ...
                        graph_pairs = from par in read_parameters_vdp10 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 15:
                        ...
                        graph_pairs = from par in read_parameters_vdp15 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 16:
                        ...
                        graph_pairs = from par in read_parameters_vdp16 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 17:
                        ...
                        graph_pairs = from par in read_parameters_vdp17 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 18:
                        ...
                        graph_pairs = from par in read_parameters_vdp18 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 19:
                        ...
                        graph_pairs = from par in read_parameters_vdp19 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 20:
                        ...
                        graph_pairs = from par in read_parameters_vdp20 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 29:
                        ...
                        graph_pairs = from par in read_parameters_vdp29 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 30:
                        ...
                        graph_pairs = from par in read_parameters_vdp30 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 31:
                        ...
                        graph_pairs = from par in read_parameters_vdp31 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 32:
                        ...
                        graph_pairs = from par in read_parameters_vdp32 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 33:
                        ...
                        graph_pairs = from par in read_parameters_vdp33 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
                    ...
                    case 44:
                        ...
                        graph_pairs = from par in read_parameters_vdp44 select new TimeParameterPair() { dt = (DateTime)par.dateandtime, parameter = (double)par.val };
                        voltagePlot(graph_pairs);
                        parameter = "Arc_I";
