...
{
    class VacuumStrictConverter:IValueConverter
    {
        private App _application;
        private MainWindow _window;
        public VacuumStrictConverter()
        {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (_window.Vacuum_graph_pairs != null)
                {
...
//делаем так: при нажатой мышке ищем Х-координату её курсора в перечислении Vacuum_graph_pairs<ParameterPair>, 
